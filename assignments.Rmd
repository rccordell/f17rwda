...
In this assignment you will work either individually or in pairs to create a new Wikipedia article or upgrade a [Wikipedia stub](https://en.wikipedia.org/wiki/Wikipedia:Stub). Your article should at least reach C class, but B is better. You should use the [WikiProject Assessment guidelines](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_assessment) to shape your process.
