...
In this assignment you will work either individually or in pairs to create a new [Wikipedia stub](https://en.wikipedia.org/wiki/Wikipedia:Stub) or improve a stub into a start-class article. You should use the [WikiProject Assessment guidelines](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_assessment) to shape your process.
