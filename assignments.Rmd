...
### The Nitty-Gritty
We will begin the semester's writing assignments with a typical academic essay of 5-6 pages, each addressing themes around digital reading. In the first weeks of class we will discuss the expectations for this paper, brainstorm essay topics, and outline the elements of effective academic argument. Briefly, however, you should expect to:

1. Make a specific, debatable claim;
2. Defend that claim with reasons and evidence, some of which will come from your own research;
